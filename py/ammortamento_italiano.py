...
def gestisci_grafico(df: pd.DataFrame):
    ...
    # 4. Titolo Globale
    fig.suptitle("Piano di Ammortamento all'Italiano (Quota Capitale Costante)", fontsize=18, fontweight='bold')
    ...
    testo_specifiche = (
        ...
        "Tasso fisso | Capitalizzazione semplice | Rata decrescente."
    )
    ...
    if salva in ['s', 'si', 'y', 'yes']:
        ...
        if not nome_file:
            nome_file = "grafico_ammortamento_italiano.png"
...
if __name__ == "__main__":
    print("=========================================")
    print("   CALCOLO AMMORTAMENTO ALLA ITALIANO    ")
    print("=========================================\n")
    ...
    df_ammortamento = ammortamento_italiano(cap, tasso, rate)
