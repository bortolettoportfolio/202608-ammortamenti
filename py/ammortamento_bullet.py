...
def gestisci_grafico(df: pd.DataFrame):
    ...
    # 4. Titolo Globale
    fig.suptitle("Piano di Ammortamento Bullet (Rimborso a Scadenza)", fontsize=18, fontweight='bold')
    ...
    testo_specifiche = (
        ...
        "Tasso fisso | Interessi periodici | Rimborso integrale a scadenza."
    )
    ...
    if salva in ['s', 'si', 'y', 'yes']:
        ...
        if not nome_file:
            nome_file = "grafico_ammortamento_bullet.png"
...
if __name__ == "__main__":
    print("=========================================")
    print("      CALCOLO AMMORTAMENTO BULLET        ")
    print("=========================================\n")
    ...
    df_ammortamento = ammortamento_bullet(cap, tasso, rate)
